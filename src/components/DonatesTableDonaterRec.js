...
import DonatesTableDonater from './DonatesTableDonater';
...
function getProducts() {
  ...
  for (let i = 0; i < 12; i++) {
    ...
    products.push({
      ...
      name: 'Username' + id,
      surname: "Suname",
      phone: "080-606-"+ Math.floor((Math.random() * 10000)),
...
export default class NewsTableRec extends React.Component {
  ...
  render() {
    return (
      <DonatesTableDonater onSortChange={this.onSortChange.bind(this)}
