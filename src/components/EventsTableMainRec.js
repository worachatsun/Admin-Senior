...
import EventsTableMain from './EventsTableMain';
...
function getProducts() {
  ...
  for (let i = 0; i < 12; i++) {
    ...
    products.push({
      id: id,
      name: 'Event name ' + id,
      limit: Math.floor((Math.random() *200)+1),
      location: "126 ถนน ประชาอุทิศ แขวง บางมด เขต ทุ่งครุ กรุงเทพมหานคร 10140",
      RegisterDate: "2014-10-01 - 2015-01-25",
      EventDate: "2015-02-01 18:00 - 2015-02-01 24:00",
      EventOwner: 'Pitawat Pisatsudjja',
    });
  }
  return products;
}
      
export default class EventsTableMainRec extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <EventsTableMain onSortChange={this.onSortChange.bind(this)}
