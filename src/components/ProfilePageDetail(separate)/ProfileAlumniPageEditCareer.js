...
class ProfileAlumniPageEditCareer extends Component {
     constructor(props) {
        super(props)
        this.state = {
            career_title: '',
                ...
                <form onSubmit={this.onSubmitCareer}>
                    ...
                    <div className="form-group">
                        ...
                        <div className="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" className="form-control" value={this.state.career_title} onChange={(text) => this.setState({ career_title: text.target.value })} required="required" />
                        </div>
                    </div>
                    <div className="form-group">
...
export default ProfileAlumniPageEditCareer