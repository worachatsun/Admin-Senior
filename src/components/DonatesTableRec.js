...
import DonatesTable from './DonatesTable';
...
function getProducts() {
    ...
    for (let i = 0; i < 12; i++) {
        ...
        products.push({
            ...
            project_owner: Math.floor((Math.random() * 2)),
            created_at: "2016-11-15 17:12",
...
export default class NewsTableRec extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <DonatesTable onSortChange={this.onSortChange.bind(this)}
