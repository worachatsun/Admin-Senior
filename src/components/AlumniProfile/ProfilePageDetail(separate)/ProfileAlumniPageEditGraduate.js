...
class ProfileAlumniPageEditGraduate extends Component {
    constructor(props) {
        super(props)
        this.state = {
            graduate_facualty: '',
    ...
    onSubmitGraduate(event) {
        ...
        this.props.editGraduate(this.state)
    }
    navigateBack() {
        this.goBack();
    }
...
export default ProfileAlumniPageEditGraduate